...
const messages = {
  en: {
    ...
    'settings.title': 'Settings', 'settings.close': 'Close settings', 'settings.general': 'General', 'settings.ai': 'AI', 'settings.search': 'Search', 'settings.shortcuts': 'Shortcuts', 'settings.status': 'Status', 'settings.appearance': 'Appearance', 'settings.privacy': 'Privacy', 'settings.keyboard': 'Keyboard', 'settings.about': 'About',
  ...
  'zh-CN': {
    ...
    'settings.title': '设置', 'settings.close': '关闭设置', 'settings.general': '通用', 'settings.ai': 'AI', 'settings.search': '搜索', 'settings.shortcuts': '快捷方式', 'settings.status': '运行状态', 'settings.appearance': '外观', 'settings.privacy': '隐私', 'settings.keyboard': '键盘', 'settings.about': '关于',
